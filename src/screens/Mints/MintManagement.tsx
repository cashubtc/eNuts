...
export default function MintManagement({
    ...
    const handleMintName = async () => {
        ...
        openPromptAutoClose({
            msg: t("cutomNameAdded", { ns: NS.mints }),
            success: true,
        });
    };
    ...
    const handleMintSwap = async () => {
        const mints = (await getMintsUrls(true)).filter(
            (m) =>
                m.mintUrl !== route.params.mint?.mintUrl &&
                m.mintUrl !== _testmintUrl
        );
    ...
    const handleDefaultMint = async () => {
        ...
        openPromptAutoClose({
            msg: t("updatedDefault", { ns: NS.mints }),
            success: true,
        });
    };
        ...
        <View style={{ flex: 1, backgroundColor: color.BACKGROUND }}>
                ...
                <View>
                    ...
                    <View style={globals(color).wrapContainer}>
                        ...
                        <MintOption
                            txt={
                                isDefault
                                    ? t("removeDefault", { ns: NS.mints })
                                    : t("setDefault", { ns: NS.mints })
                            }
            ...
            {customNameOpen && (
                <MyModal
                    ...
                    animation="slide"
                    visible
                    close={() => setCustomNameOpen(false)}
                >
                    <Text style={globals(color).modalHeader}>
                        {edit
                            ? t("editMintName", { ns: NS.mints })
                            : t("addCustomName", { ns: NS.mints })}
                    </Text>
                    <TxtInput
