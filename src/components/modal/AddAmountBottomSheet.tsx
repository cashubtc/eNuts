...
const AddAmountBottomSheet = forwardRef<AddAmountBottomSheetRef, AddAmountBottomSheetProps>(
  ({ onConfirm, existingAmounts }, ref) => {
    ...
    const formattedValue = inputValue ? parseInt(inputValue, 10).toLocaleString() : "";
    ...
    return (
      ...
      >
        <BottomSheetView style={[styles.container, { backgroundColor: color.BACKGROUND }]}>
          <Text style={[globals(color, highlight).modalHeader, { marginBottom: vs(8) }]}>
            Add Custom Limit
          </Text>
